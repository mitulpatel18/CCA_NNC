...
<a >
 <i class="fa fa-bell-o" ></i>
  ...
  <li class="ms-border dropdown ms-notification-btn {{ $btnColor }}" ms-channel="ncc-agency-development" ms-live-link="{{ route('ANMS.Notification.By.User',['UserId'=>\MS\Core\Helper\Comman::en4url(session('user.userData.UniqId'))]) }}"   > 
