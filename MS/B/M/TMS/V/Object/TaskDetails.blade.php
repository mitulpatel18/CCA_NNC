                   ...
                   //   dd(session()->all());
                      ...
                      ?>  
                        ...
                        @if($userRole==1)
                              ...
                              <div class="btn btn-default ms-text-black ms-mod-btn" ms-shortcut="back" ms-live-link="{{ route($link) }}"><i class="fa fa-fast-backward"  ></i><br> Go Back to Task List</div>
                                   <div class="btn btn-danger ms-text-white ms-mod-btn" ms-live-link="{{route('TMS.Task.Rise.Query',['TaskId'=>\MS\Core\Helper\Comman::en4url($data['task']['UniqId'])])}}"><i class="fa fa-question"  ></i><br> Rise Query</div>
                              
    
                        @elseif($userRole==2)

                        <div class="btn btn-info ms-text-black ms-mod-btn " ms-shortcut="back" ms-live-link="{{ route('ATMS.index.Data') }}"><i class="fa fa-fast-backward"  ></i> Go Back to Task List</div>
